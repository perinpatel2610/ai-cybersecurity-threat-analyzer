SAMPLE_LOGS = {
    "brute_force": """
2024-01-15 03:12:01 WARN  sshd[1234]: Failed password for root from 192.168.1.105 port 22 ssh2
...
""",
    "sql_injection": """
2024-01-15 14:22:01 INFO  nginx: 203.0.113.42 - GET /api/users?id=1 HTTP/1.1 200
...
""",
    "malware_c2": """
2024-01-15 02:00:01 INFO  firewall: ALLOW TCP 10.0.1.55:49201 -> 185.220.101.47:443
...
""",
    "normal": """
2024-01-15 09:00:01 INFO  nginx: 10.0.0.10 - GET /index.html HTTP/1.1 200
